...
// Inline SVG derived from icon-nawa.svg — avoids extra HTTP request and allows CSS sizing.
// IDs are prefixed with "ni-" to avoid collisions when multiple SVG defs coexist in the DOM.
  ...
  return (
    ...
    >
      <defs>
        ...
        <linearGradient id="ni-bgGrad" x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      {/* Background */}
      <rect width="800" height="800" fill="url(#ni-bgGrad)" rx="60" />

      {/* Orbit rings */}
      <circle cx="400" cy="350" r="220" fill="none" stroke="url(#ni-cyanGrad)" strokeWidth="2" strokeDasharray="10 15" opacity="0.4" />
      <circle cx="400" cy="350" r="200" fill="none" stroke="url(#ni-goldGrad)" strokeWidth="1" opacity="0.3" />
      ...
      <g transform="translate(0, -20)">
        ...
        <path d="M 300 240 L 500 240 L 460 320 L 340 320 Z" fill="#121A2F" stroke="url(#ni-cyanGrad)" strokeWidth="4" strokeLinejoin="round" />

        <path d="M 300 240 L 220 420 L 320 390 Z" fill="#121A2F" stroke="url(#ni-cyanGrad)" strokeWidth="4" strokeLinejoin="round" />
        <path d="M 500 240 L 580 420 L 480 390 Z" fill="#121A2F" stroke="url(#ni-cyanGrad)" strokeWidth="4" strokeLinejoin="round" />

        <path d="M 340 320 L 460 320 L 400 440 Z" fill="#080C16" stroke="url(#ni-goldGrad)" strokeWidth="4" strokeLinejoin="round" />
      ...
      <g transform="translate(0, 30)">
        ...
        <path d="M 260 495 Q 330 475 400 525" fill="none" stroke="#FFFFFF" strokeWidth="2" opacity="0.5" />

        <path d="M 540 480 Q 470 460 400 510 L 400 560 Q 470 510 540 530 Z" fill="url(#ni-cyanGrad)" opacity="0.6" />
        <path d="M 540 495 Q 470 475 400 525" fill="none" stroke="#FFFFFF" strokeWidth="2" opacity="0.5" />
      </g>

      {/* Wordmark */}
      <text x="400" y="680" fontFamily="'Segoe UI', Roboto, Helvetica, Arial, sans-serif" fontSize="52" fontWeight="900" fill="#FFFFFF" textAnchor="middle" letterSpacing="12">NAWA</text>
      <text x="400" y="730" fontFamily="'Segoe UI', Roboto, Helvetica, Arial, sans-serif" fontSize="22" fontWeight="400" fill="#00F0FF" textAnchor="middle" letterSpacing="16">LEARN</text>
